					...
					<div className='flex-[66%] p-4'>
						<div className='flex flex-col gap-10'>
							...
							<div className='flex flex-wrap gap-4  items-center'>
								...
								<span className='ti-help-alt flex items-center text-xl mt-1 ml-[-2px] text-gray-500'>
								</span>
								...
								<span className='flex gap-8 items-center sm:hidden ml-4'>
									...
									<button>
										<i className='fa-regular fa-heart text-primary  text-3xl'>
										</i>
									</button>
								</span>
							</div>
						...
						<div className='p-6 hidden sm:block bg-[#fafafa] mt-5'>
							<div className='flex gap-4 flex-wrap'>
								<span className='text-[16px] line-through font-normal text-neutral-400 flex'>
									<span className='text-[11px] mt-1 mr-1'>
										₫
									</span>
									{product &&
							...
							<div className='flex gap-4 items-center'>
								...
								<div className='flex flex-wrap flex-col justify-center items-start'>
									<div className='flex gap-4'>
										...
										<span className='ti-help-alt flex items-center text-xl mt-1 ml-[-2px] '>
										</span>
									</div>
									...
									<div className='capitalize flex gap-4'>
										...
										<span className='flex flex-col'>
											<div className='hidden md:flex items-center gap-4 py-2'>
												...
												<span>
													phường tràng tiền, quận hoàn
													kiếm
													<i className='ti-angle-down ml-2'>
													</i>
												</span>
											</div>
							...
							<div className='flex flex-col md:flex-row gap-4 capitalize py-3 flex-wrap'>
								...
								<span className=' font-normal'>
									<div className='flex gap-4 flex-wap'>
										<span className='select-type-btn'>
											trắng
										</span>
										<span className='select-type-dis-btn'>
											xám bạc
										</span>
										<span className='select-type-btn'>
											đen
